...
ROR = pd.read_csv(f'./data/code/matchDuplicatedNames/matchScopusToROR/ror_matches.csv', encoding='utf-8', dtype=object)
...
def match_institutions(inst_EMEC, inst_ROR):
    ...
    flag_columns = ['name_match', 'url_match', 'domain_match']
...
matched_df.to_csv('./data/code/matchDuplicatedNames/matchRORToEMEC/matches.csv', index=False)
institutions_b_with_counts.to_csv('./data/code/matchDuplicatedNames/matchRORToEMEC/counting.csv', index=False)
